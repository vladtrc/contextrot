...
После того как мы кратко познакомились с htmx и всё таки решили вопреки здравому смыслу пойти в кресовый поход против `javascript`, `vite`, `react`, `ангуляра` и здравого смысла, пора внести важное уточнение какие же задачи мы можем решить с помощью htmx а какие - нет.
