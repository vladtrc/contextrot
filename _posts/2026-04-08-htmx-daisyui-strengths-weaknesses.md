...
1. Вайбкодить весь сырой css без какой-либо библиотеки - оказалось что тут не всё так просто и задачки занимали _ОЧЕНЬ_ много времени даже простые даже если как-то структурировать css. И много токенов уходило на "поддержку" этих стилей
