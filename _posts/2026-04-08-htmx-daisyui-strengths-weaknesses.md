...
Htmx решает одну задачу: обновляет определенную часть интерфейса куском HTML который вернул сервер. Можно настраивать когда обновлять, что именно менять и как это встраивать в DOM, но суть именно такая.
...
2. Вайбкодить весь сырой css с помощью "очистителей" то есть чтото типа [a-more-modern-css-reset](https://piccalil.li/blog/a-more-modern-css-reset) - разницы с первым пунктом особо не заметил.
